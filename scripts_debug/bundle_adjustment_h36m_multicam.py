...
import csv
import pandas as pd
import bundle_adjustment_plotly_multi_h36m
...
time_pred = {'S1': {0: [0, 0, 0], 50: [50, 50, 50], 100: [100, 100, 100], 150: [150, 150, 150], 200: [200, 200, 200]}, 
             'S5': {0: [0, 0, 0], 50: [50, 50, 50], 100: [100, 100, 100], 150: [150, 150, 150], 200: [200, 200, 200]}, 
             'S6': {0: [0, 0, 0], 50: [50, 50, 50], 100: [100, 100, 100], 150: [150, 150, 150], 200: [200, 200, 200]}, 
             'S7': {0: [0, 0, 0], 50: [50, 50, 50], 100: [100, 100, 100], 150: [150, 150, 150], 200: [200, 200, 200]}, 
             'S8': {0: [0, 0, 0], 50: [50, 50, 50], 100: [100, 100, 100], 150: [150, 150, 150], 200: [200, 200, 200]}, 
             'S9': {0: [0, 0, 0], 50: [50, 50, 50], 100: [100, 100, 100], 150: [150, 150, 150], 200: [200, 200, 200]}, 
             'S11': {0: [0, 0, 0], 50: [50, 50, 50], 100: [100, 100, 100], 150: [150, 150, 150], 200: [200, 200, 200]}}
#for subject in ['', 'S11']:
    ...
    for k in range(len(experiments_time)):
        ...
        for exp in range(len(plane_dict_array_experiment1_array) - 1):
            for mode in [True, False]:
                ...
                matched_points = bundle_adjustment_plotly_multi_h36m.match_3d_multiview(sync_dict_array, pre_bundle_cal_array, single_view_cal_array, pose_2d_array_comb,center_array, output_path, scale = scale, title = 'rotation perturb TRACKS', name = ['perturb'], k = 20)
                #matched_points = bundle_adjustment_plotly_multi.match_3d_farthest_point(sync_dict_array, pre_bundle_cal_array, single_view_cal_array, pose_2d_array_comb,center_array, output_path, scale = scale, title = 'rotation perturb TRACKS', name = ['perturb'], k = 20)
                ...
                bundle_rotation_matrix_array, bundle_position_matrix_array, bundle_intrinsic_matrix_array = bundle_adjustment_plotly_multi_h36m.bundle_adjustment_so3_gt(matched_points, bundle_rotation_matrix_array, bundle_position_matrix_array, bundle_intrinsic_matrix_array, gt_rotation_array, gt_translation_array, gt_intrinsics_array, h, distortion_k_array, distortion_p_array, save_dir = output_path, iteration = 200, run_name = run_name, w0 = w0, w1 = w1, w2 = w2, w3 = w3)
                #print("*************************")
                #print(cam_axis4)
                #print("&&&&&&&&&&&&&&&&&&&&&&&&&")
