...
name = str(today.strftime('%Y%m%d_%H%M%S')) + '_EPFL_terrace1_res50'

#Gets the hyperparamter from hyperparameter.json
threshold_euc, threshold_cos, angle_filter_video, confidence, termination_cond, num_points, h, iter, focal_lr, point_lr = util.hyperparameter('/local/tangytob/Summer2023/multiview_synchronization/scripts_pairwise_bundle_temporal/hyperparameter_terrace.json')
...
load_dict = [{'cam_matrix': [[477.43791111532425, 0.0, 180.0], [0.0, 477.43791111532425, 144.0], [0.0, 0.0, 1.0]], 'ground_normal': [0.0050005391068788894, -0.9580524621124061, -0.2865492530944656], 'ground_position': [0.45473315, 0.3978593 , 7.86199131]}, {'cam_matrix': [[477.43791111532425, 0.0, 180.0], [0.0, 477.43791111532425, 144.0], [0.0, 0.0, 1.0]], 'ground_normal': [0.0050005391068788894, -0.9580524621124061, -0.2865492530944656], 'ground_position': [0.45473315, 0.3978593 , 7.86199131]}, {'cam_matrix': [[477.43791111532425, 0.0, 180.0], [0.0, 477.43791111532425, 144.0], [0.0, 0.0, 1.0]], 'ground_normal': [0.008877293235841128, -0.9446537342711915, -0.3279489533331323], 'ground_position': [-0.03008517,  0.0469843 ,  8.6744278 ]}, {'cam_matrix': [[477.43791111532425, 0.0, 180.0], [0.0, 477.43791111532425, 144.0], [0.0, 0.0, 1.0]], 'ground_normal': [0.008877293235841128, -0.9446537342711915, -0.3279489533331323], 'ground_position': [-0.03008517,  0.0469843 ,  8.6744278 ]}, {'cam_matrix': [[477.43791111532425, 0.0, 180.0], [0.0, 477.43791111532425, 144.0], [0.0, 0.0, 1.0]], 'ground_normal': [-0.01607488615459116, -0.972381748396943, -0.23284186354609865], 'ground_position': [ 0.05101854, -0.03431788,  9.00697907]}, {'cam_matrix': [[477.43791111532425, 0.0, 180.0], [0.0, 477.43791111532425, 144.0], [0.0, 0.0, 1.0]], 'ground_normal': [-0.01607488615459116, -0.972381748396943, -0.23284186354609865], 'ground_position': [ 0.05101854, -0.03431788,  9.00697907]}, {'cam_matrix': [[477.43791111532425, 0.0, 180.0], [0.0, 477.43791111532425, 144.0], [0.0, 0.0, 1.0]], 'ground_normal': [-0.007354234919954152, -0.9733059351698659, -0.2293937047781694], 'ground_position': [0.26211095, 0.09842344, 8.21548955]}, {'cam_matrix': [[477.43791111532425, 0.0, 180.0], [0.0, 477.43791111532425, 144.0], [0.0, 0.0, 1.0]], 'ground_normal': [-0.007354234919954152, -0.9733059351698659, -0.2293937047781694], 'ground_position': [0.26211095, 0.09842344, 8.21548955]}]

time_pred = {
"0_terrace1-c0_avi_terrace1-c1_avi":	2,
"0_terrace1-c1_avi_terrace1-c2_avi":	11,
"0_terrace1-c2_avi_terrace1-c3_avi":	-6,
"0_terrace1-c0_avi_terrace1-c2_avi":	6,
"0_terrace1-c1_avi_terrace1-c3_avi":	-16,
"25_terrace1-c0_avi_terrace1-c1_avi":	27,
"25_terrace1-c1_avi_terrace1-c2_avi":	35,
"25_terrace1-c2_avi_terrace1-c3_avi":	19,
"25_terrace1-c0_avi_terrace1-c2_avi":	31,
"25_terrace1-c1_avi_terrace1-c3_avi":	9,
"50_terrace1-c0_avi_terrace1-c1_avi":	54,
"50_terrace1-c1_avi_terrace1-c2_avi":	59,
"50_terrace1-c2_avi_terrace1-c3_avi":	44,
"50_terrace1-c0_avi_terrace1-c2_avi":	56,
"50_terrace1-c1_avi_terrace1-c3_avi":	34
}
#stop
num = 0
for vid in terrace_array_names:
    ...
    datastore = data.coco_mmpose_dataloader(points_2d, bound_lower = 200, bound = 2500) 
    ...
    for cam in cam_comb:
        ...
        for exp in range(0, 1):
            ...
            #for mode in [True]:
                ...
                if mode == True:
                    best_shift_array = [time_pred[str(experiments_time[k]) + '_' + str(terrace_array_names[cam1]) + '_' + str(terrace_array_names[cam2])]]
