...
threshold_euc, threshold_cos, angle_filter_video, confidence, termination_cond, num_points, h, iter, focal_lr, point_lr = util.hyperparameter('../hyperparameters/hyperparameter_terrace_multicam.json')
...
tsai_cal = ['terrace-tsai-c0.xml', 'terrace-tsai-c1.xml', 'terrace-tsai-c2.xml']
terrace_array_names = ['terrace1-c0_avi', 'terrace1-c1_avi', 'terrace1-c2_avi']
...
for vid in terrace_array_names:
    intrinsic_gt_path = '../data/terrace/tsai/single_calibration_' + str(num) + '_.json'
    
    with open(intrinsic_gt_path, 'r') as f:
        intrinsic_gt = json.load(f)
    
    cam_extrinsic_path = '../calibration/terrace-tsai-c' + str(num) + '.xml'
    ...
    with open('../data/terrace/terrace/detections/result_' + vid.split('_')[0] + '_.json', 'r') as f:
        points_2d = json.load(f)
    ...
    frame_dir = '../data/terrace/terrace/frames/' + vid + '/00000000.jpg'
